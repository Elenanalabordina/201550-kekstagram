  ...
  Resizer.prototype = {
    ...
    redraw: function() {
      ...
      this._ctx.strokeRect(
          (-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2, //координата x
          (-this._resizeConstraint.side / 2) - this._ctx.lineWidth / 2,// координата y
          this._resizeConstraint.side - this._ctx.lineWidth / 2,//ширина
          this._resizeConstraint.side - this._ctx.lineWidth / 2);//высота
